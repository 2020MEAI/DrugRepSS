...
###################1.
# 读取表格数据
# table_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\drug_vector.xlsx'  # 表格文件路径
...
# # 将结果保存到新的表格文件中
# output_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\drug_vector_合并.xlsx'
...
# #
# 读取表格1数据
# table1_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\drug_vector_合并.xlsx'  # 表格1文件路径
# table1_df = pd.read_excel(table1_path)
#
# # 读取表格2数据
# table2_path = 'D:\\yanjiu\\大模型数据集\\token为10\\测试集.xlsx'  # 表格2文件路径
...
#
# # 将结果保存到新的表格文件中
# output_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\output测试集.xlsx'
...
# 读取表格数据
table_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\output测试集.xlsx'  # 表格文件路径
table_df = pd.read_excel(table_path)

output_path = 'D:\\yanjiu\\graphprompt\\MultiGPrompt\\output测试集.txt'
