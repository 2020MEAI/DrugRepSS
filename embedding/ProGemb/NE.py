...
if __name__ == '__main__':
  ...
  table_path = 'D:\\yanjiu\\大模型数据集\\ProG_drug+dis\\disease_drug_vector.xlsx'  # 请替换为实际文件路径
  ...
  file_path = 'D:\\yanjiu\\大模型数据集\\ProG_drug+dis\\dis_drug_list_new.csv'  # 请替换为你的实际文件路径
